...
package flashx.textLayout.operations
{
	 ...
	 * @langversion 3.0 
	 */			
	public class CloseListOperation extends FlowTextOperation
	{
		 ...
		 * @playerversion AIR 1.5
	 	 * @langversion 3.0 
		 */
		function CloseListOperation(operationState:SelectionState)
		{
		...
		{ 
			...
			//ParaEdit.
			//var fle:FlowLeafElement = ParaEdit.createElement(new ListPaddingElement(), paraSelBegIdx, "flashx.textLayout.elements.list.ListPaddingElement", null);
		...
		tlf_internal override function merge(operation:FlowOperation):FlowOperation
		{
			...
			if ((operation is CloseListOperation) || (operation is InsertTextOperation) || (operation is PasteElementsOperation))
