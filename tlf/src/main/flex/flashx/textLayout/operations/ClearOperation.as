package flashx.textLayout.operations
{
	 ...
	 * 
	 */
	public class ClearOperation extends FlowTextOperation
	{
		 ...
		 * 
		 */
		public function ClearOperation( operationState:SelectionState, interactionManager:ExtendedEditManager )
		{
		...
		public override function doOperation():Boolean	{
			...
			if(isCaretSelection()) {
				interactionManager.deleteText(null);
			} else {
