package flashx.textLayout.elements
{
	...
	public class ListItemXElement extends DivElement
	{
		...
		public function ListItemXElement()
		{
			super();
		...
		{
			if ( child is DivElement || child is ListXElement )
			{
...
//				if ( parent.parent )
//				{
//					if ( parent.parent is ListItemXElement )
//					{
						start = '\t' + separator;
//						end = '\n';
...
//			end += '\n';
		...
		{
			return elem is SpanElement || elem is InlineGraphicElement || elem is LinkElement || elem is DivElement || elem is ParagraphElement || elem is ListXElement || elem is FlowGroupElement || elem is FlowLeafElement;
		}
